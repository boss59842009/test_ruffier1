...
class MainScreen(Screen):
    def __init__(self, **kwargs):
        ...
        name_lbl = Label(text="Введіть імʼя", color=lbl_color, bold=True, font_size=35)
        self.name_input = TextInput(text='Микола', multiline=False)
        age_lbl = Label(text="Введіть вік", color=lbl_color, bold=True, font_size=35)
